...
/**
 * @file
 * Contains \Drupal\total_control\Plugin\Block\ContentOverview.
 */
...
class ContentOverview extends BlockBase implements BlockPluginInterface {
  ...
  public function blockForm($form, FormStateInterface $form_state) {
    ...
    $form ['total_control_types_overview'] = array(
      '#type' => 'checkboxes',
    ...
    $form ['total_control_comments_overview'] = array(
      '#type' => 'checkboxes',
    ...
    $form ['total_control_spam_overview'] = array(
      '#type' => 'radios',
